    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/guardController/CheckEditGuard" enctype="multipart/form-data">
                    <div class="form-body">
                    <div class="row">
                    ...
                    <div class="row">
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_name)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="name" value="<?=$row->name?>" placeholder="اسم">
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_fname)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">اسم*</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="fname" value="<?=$row->fname?>" placeholder="اسم">
                                <div class="form-control-focus"> </div>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_job)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input style="text-align: right;" type="text" class="form-control date" name="job" value="<?=$row->job?>" placeholder="وظیفه">
                                <div class="form-control-focus"> </div>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_location)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input style="text-align: right;" type="text" class="form-control date" name="location" value="<?=$row->location?>" placeholder="موقعیت">
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_phone)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="phone" value="<?=$row->phone?>" placeholder="شماره تماس">
                                <div class="form-control-focus"> </div>
