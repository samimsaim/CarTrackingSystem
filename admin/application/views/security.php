    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="tiles" style="margin-right: 100px;" >
                <a href="<?=base_url()?>index.php/eventController/index">
            ...
            <a href="<?=base_url()?>index.php/eventController/ladarakView">
            ...
            <a href="<?=base_url()?>index.php/eventController/victimeView">
            ...
            <a href="<?=base_url()?>index.php/TransportRepController/yearlyRep">
             ...
             <a href="<?=base_url()?>index.php/eventController/ekhtetafView">
             ...
             <a href="<?=base_url()?>index.php/eventController/theftView">
             ...
             <a href="<?=base_url()?>index.php/eventController/destroyView">
             ...
             <a href="<?=base_url()?>index.php/eventController/afrazView">
             ...
             <a href="<?=base_url()?>index.php/eventController/threadView">
             ...
             <a href="<?=base_url()?>index.php/eventController/paradView">
             ...
             <a href="<?=base_url()?>index.php/eventController/preventView">
                 <div class="tile double selected bg-yellow">
                    <div class="corner">
                    </div>
                    <div class="check">
