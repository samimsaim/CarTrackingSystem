    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckEditThread">
                    <div class="form-body">
                    <div class="row">
                    </div>
                    ...
                    <div class="row">
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_orgName)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="typeOfThread" value="<?=$key->typeOfThread?>" placeholder="نوع تهدید">
                                <div class="form-control-focus"> </div>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_mushajera)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="mushajera" value="<?=$key->mushajera?>" placeholder="مشاجره لفظی">
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_tadaber)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="tadaber" value="<?=$key->etekhazTadaber?>" placeholder="اتخاذ تدابیر">
                                <div class="form-control-focus"> </div>
