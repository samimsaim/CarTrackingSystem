    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/mainPageController/index">توزیع  مبلایل</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>توزیع مبلایل</b>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">توزیع  مبلایل</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                  <a href="<?=base_url()?>index.php/moblailController/addMoblail"><button id="sample_editable_1_new" class="btn btn-circle green-meadow sbold green"> اضافه نمودن
                                        ...
                                        <thead>
                                            <tr style="text-align: center;">
                                                ...
                                                <th style="text-align: center;">نمبر حواله</th>
                                                 <th style="text-align: center;">مقدار حواله</th>
                                           ...
                                           ?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><?=$key->user?></td>
                                               ...
                                               <td style="text-align: center;"><?=$row->meqdarHawala?></td>
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/moblailController/moblailDetail?id=<?=$row->id?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                                <a href="<?=base_url()?>index.php/moblailController/editMoblail?id=<?=$row->id?>" title="ویرایش" class="btn btn-icon-only btn-circle btn-success">ویرایش</a>
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/moblailController/DeleteMoblil?id="+id;
        else
            return false;
    }
</script>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url()?>index.php/moblailController/index" class="btn btn-primary">بستن</a>
                </div>
            </div>
        </div>
    </div>
