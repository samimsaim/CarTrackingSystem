    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/UsersController/index">گزارش ربع وار مبلایل</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>گزارش</b>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">گزارش ربع وار مبلایل</span>
                </div>
                <div class="actions">
                                ...
                                <table class="table table-hover">
                                  ...
                                  <!--   <tr>
                                    ...
                                    <tr style="background-color: yellow;">
                                        ...
                                        $result1= $this->db->select_sum('meqdarHawala');
                                        $result1=$this->db->get('moblail')->row();
                                        $query1= $result1->meqdarHawala;
                                        $this->db->where('car_id',$row->id);
                                         $this->db->where('DATE_FORMAT(tarikhHawala,"%Y")',date('Y', strtotime(date($_GET['dat']))));
                                         $this->db->where('DATE_FORMAT(tarikhHawala,"%m")','03');
                                        $result2= $this->db->select_sum('meqdarHawala');
                                        $result2=$this->db->get('moblail')->row();
                                        $query2= $result2->meqdarHawala;
                                         ?>
