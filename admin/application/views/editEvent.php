    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn btn-circle green-meadow" href="<?=base_url()?>index.php/eventController/index" style="font-size: 16px;">
                        <i class="fa fa-share"></i>برگشت</a>
                    </a>
                </div>
            </div>
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckEditEvent">
                    <div class="form-body">
                    <div class="row">
                    </div>
                    ...
                    <div class="row">
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_date)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="date" value="<?=$key->orgName?>" placeholder="date">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_typeOfJob)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="typeOfJob">
                                   <option value="<?=$key->typOfJob?>"><?=$key->typOfJob?>ه</option>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_gender)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="gender">
                                   <option value="<?=$key->orgName?>"><?=$key->gender?></option>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <a href="<?=base_url()?>index.php/eventController/index" class="btn btn-circle yellow-gold">لغو</a>
                                <input type="submit" name="editEvent" class="btn btn-circle green-meadow" value="ذخیره"/>
                            </div>
                        </div>
                    </div>
                </form>
