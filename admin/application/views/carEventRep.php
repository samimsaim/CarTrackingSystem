    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn btn-circle green-meadow" href="<?=base_url()?>index.php/careRepController/eventRep?id=<?=$_GET['id'];?>" style="font-size: 16px;">
            ...
            <div class="tiles" style="margin-right: 100px;" >
                <a href="<?=base_url()?>index.php/careRepController/eventRep?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/careMonthlyRep?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/quarterView?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/yearlyRep?id=<?=$_GET['id'];?>">
