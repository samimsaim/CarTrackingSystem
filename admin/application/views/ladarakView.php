    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/mainPageController/index">لیست  توقیف و لادرک پرسونل وزارت معارف</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>توقیف و لادرک پرسونل</b>
                </li>
            </ul>
        </div>
                <div class="row">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">توقیف و لادرک پرسونل</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                  <a href="<?=base_url()?>index.php/eventController/addLadarak"><button id="sample_editable_1_new" class="btn btn-circle green-meadow sbold green"> اضافه نمودن
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        <thead>
                                            <tr style="text-align: center;">
                                                ...
                                                <th style="text-align: center;">اسم نهاد</th>
                                                <th style="text-align: center;"> ارگان توقیف کننده</th> <th style="text-align: center;">نوعیت واقعه</th>
                                        ...
                                        <tbody style="text-align: center;">
                                          <?php foreach($data as $key) {?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><?=$key->tawqefOrg?></td>
                                               <td style="text-align: center;"><?=$key->typeOfEvent?></td>
                                                <td style="text-align: center;"><?=$key->typeOfJob?></td>
                                               <td style="text-align: center;"><?=$key->gender?></td>
                                              
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/eventController/ladarakDetail?id=<?=$key->id?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                                <a href="<?=base_url()?>index.php/eventController/editLadarak?id=<?=$key->id?>" title="ویرایش" class="btn btn-icon-only btn-circle btn-success">ویرایش</a>
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/eventController/DeletLadarak?id="+id;
        else
            return false;
    }
</script>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url()?>index.php/eventController/ladarakView" class="btn btn-primary">بستن</a>
                </div>
            </div>
        </div>
    </div>
