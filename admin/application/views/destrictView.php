                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <?php $this->db->where('id',$row->pro_id);
                             ...
                             <?php }?>
                                 ...
                                 <td style="text-align: center;"><?=$row->updateDate?></td>
                                 <td style="text-align: center;">
                                 <a type="button" class="btn btn-circle btn-icon-only btn-success editbtn" ><span class="fa fa-pencil"></a>
                                <a class="btn btn-circle btn-icon-only btn-danger" href="javascript:void(0);" onclick="delete_record(<?=$row->id?>);" data-toggle="tooltip" data-placement="top" title="حذف"><span class="fa fa-trash-o"></a>
                                </td>
                                </tr>
                              <?php }?>
                            </tbody>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">اضافخ نمودن  ولسوالی</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/provinceController/addDestrict">
                    <div class="form-group form-md-line-input col-md-4 has-success">
                                <select class="form-control" name="province">
                                    <option <?php if(!empty($Field_data['province']) && $Field_data['faculty'] == 0) echo ' selected '?> value="0">انتخاب  ولایت</option>
                                    <?php foreach ($key as $value) { ?>
                                    <option <?php if(!empty($Field_data['faculty']) && $Field_data['faculty'] == $row->mag_no) echo ' selected '?> value="<?=$value->id?>]"><?=$value->name?></option>
                                    <?php }?>
                                </select>
                                ...
                                <?php }?>
                                <label for="form_control_1">انتخاب ولایت</label>
                        </div>
                    <div class="form-group">
                        <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="name" class="form-control" id="form_control_1" placeholder="نام  ولسوالی"  required>
                            <label for="form_control_1">نام  ولسوالی</label>
                        </div>
...
<div class="modal fade" id="editmodal" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" align="right" data-dismiss="modal" >&times;</button>
                <h4 class="modal-title">ویرایش ولسوالی</h4>
            </div>

            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/provinceController/updateDestrict">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="name" class="form-control" id="publisher" placeholder="نام ولایت"  required>
                            <label for="form_control_1">نام ولایت</label>
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/provinceController/deleteDestrict?id="+id;
        else
            return false;
    }
</script>
        ...
        <div id="success" class="modal fade " role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="<?php echo base_url()?>index.php/provinceController/destrict" class="btn btn-circle green-meadow">بستن</a>
                    </div>
                </div>
            </div>
        </div>
