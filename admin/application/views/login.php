...
<html lang="en" dir="rtl">
    ...
    <head>
        <meta charset="utf-8" />
        <title>سیستم مدیریتی ریاست خدمات</title>
    ...
    <!-- END HEAD -->
    <body class="login" style="background:url(<?=base_url()?>../assets/img/9.jpg) no-repeat top center fixed;background-size: cover;">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <a href="<?=base_url()?>index.php/loginController/index">
                <img style="width:140px; margin-top:10px; margin-bottom:-20px" src="<?= base_url()?>assets/img/logos.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
           ...
           echo form_open('loginController/auth')?>
                <h3 class="form-title" style="text-align:center;  ">ورود به سیستم ریاست خدمات</h3>
