    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/mainPageController/index">توزیع تیل</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>توزیع تیل</b>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">توزیع تیل</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                  <a href="<?=base_url()?>index.php/fuelController/addFuel"><button id="sample_editable_1_new" class="btn btn-circle green-meadow sbold green"> اضافه نمودن
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        <thead>
                                            <tr style="text-align: center;">
                                                ...
                                                <th style="text-align: center;">پلیت</th>
                                               
                                                <th style="text-align: center;"> استقاده کننده</th> <th style="text-align: center;">تاریخ</th>
                                          ...
                                          <?php foreach($data as $row){
                                           ...
                                           ?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><?=$key->palet?></td>
                                              <td style="text-align: center;"><?=$key->user?></td>
                                               <td style="text-align: center;"><?=$row->hawala_date?></td>
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/fuelController/fuelDetail?id=<?=$row->id?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                                <a href="<?=base_url()?>index.php/fuelController/editFuel?id=<?=$row->id?>" title="ویرایش" class="btn btn-icon-only btn-circle btn-success">ویرایش</a>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url()?>index.php/fuelController/index" class="btn btn-primary">بستن</a>
                </div>
            </div>
        </div>
    </div>
