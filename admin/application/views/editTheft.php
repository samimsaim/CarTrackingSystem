    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/studentController/index">سرقت در مکاتب و نهاد های تعلیمی</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>اضافه  نمودن  رویداد  سرقت</b>
                </li>
            </ul>
        </div>
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    ...
                    <span class="caption-subject bold uppercase">اضافه نمودن  رویداد  سرقت</span>
                </div>
                <div class="actions">
                    <a class="btn btn-circle green-meadow" href="<?=base_url()?>index.php/eventController/TheftView" style="font-size: 16px;">
                        <i class="fa fa-share"></i>برگشت</a>
                    </a>
                </div>
            </div>
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckEditTheft">
                    <div class="form-body">
                    <div class="row">
                    </div>
                    ...
                    <div class="row">
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_orgName)) echo 'has-error' ?>">
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_bref)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">خلاصه مطلب*</label>
                            <div class="col-md-9">
                                <input style="text-align: right;" type="text" class="form-control" name="bref" value="<?=$key->bref?>" placeholder="خلاصه مطلب">
                                <div class="form-control-focus"> </div>
                                <?php if(!empty($error_bref)){?>
                                    <span class="help-block-error" style="color:red;"><?=$error_bref?></span>
                                <?php }?>
                            </div>
                        </div>
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_date)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="date" value="<?=$key->date?>" placeholder="date">
                                <div class="form-control-focus"> </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <a href="<?=base_url()?>index.php/eventController/theftView" class="btn btn-circle yellow-gold">لغو</a>
                                <input type="submit" name="addTheft" class="btn btn-circle green-meadow" value="ذخیره"/>
                            </div>
                        </div>
                    </div>
                </form>
