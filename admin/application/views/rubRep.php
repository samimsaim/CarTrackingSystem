    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/mainPageController/index">گزارش ربع وار عراده جات</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>گزارشات</b>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">گزارشات ربع وار</span>
                                    </div>
                                    <div class="actions">
                                        ...
                                        <tbody style="text-align: center;">
                                          <?php foreach($data as $row){ ?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/TransportRepController/purzaRub?id=<?=$row->id.'&dat='.$_GET['dat']?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                              </td>
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/TransportRepController/fuelRub?id=<?=$row->id.'&dat='.$_GET['dat']?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                              </td>
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/TransportRepController/moblailRub?id=<?=$row->id.'&dat='.$_GET['dat']?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                              </td> 
                                            </tr>
                                           <?php }?>
                                        </tbody>
