    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/PurzaJatController/CheckAddPurza">
                    <div class="form-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_jensName)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="jensName" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>" placeholder="نام جنس">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_tadadeJens)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="tadadeJens" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>" placeholder="تعداد جنس">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_qemateJens)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="qemateJens" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>" placeholder="قیمت جنس">
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_taidateQalam)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="taidateQalam" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>" placeholder="تعداد قلم">
                                <div class="form-control-focus"> </div>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_qemateMajmoe)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input style="text-align: right;" type="text" class="form-control" name="qemateMajmoe" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>" placeholder="قیمت مجموعی">
                                <div class="form-control-focus"> </div>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_tarikhSodorHawala)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input style="text-align: right;" type="date" class="form-control" name="tarikhSodorHawala" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>" placeholder="تاریخ صدور حواله">
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_naweateTawzai)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="naweateTawzai" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>" placeholder="نوعیت توزیع">
                                <div class="form-control-focus"> </div>
