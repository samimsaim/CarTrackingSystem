    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/mainPageController/index">گزارش سالانه عراده جات</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>گزارشات</b>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">گزارشات  سالانه</span>
                                    </div>
                                    <div class="actions">
                                        ...
                                        <tbody style="text-align: center;">
                                          <?php foreach($data as $row){ ?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/TransportRepController/yearlyPorza?id=<?=$row->id.'&dat='.$_GET['dat']?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                              </td>
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/TransportRepController/yearlyFuel?id=<?=$row->id.'&dat='.$_GET['dat']?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                              </td>
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/TransportRepController/yearlyMoblail?id=<?=$row->id.'&dat='.$_GET['dat']?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                              </td> 
                                            </tr>
                                           <?php }?>
                                        </tbody>
