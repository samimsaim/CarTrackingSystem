    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">اضافخ نمودن ولایت</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/provinceController/addProvince">
                    <div class="form-group">
                        <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="name" class="form-control" id="form_control_1" placeholder="نام ولایت"  required>
...
<div class="modal fade" id="editmodal" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" align="right" data-dismiss="modal" >&times;</button>
                <h4 class="modal-title">ویرایش ولایت</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/provinceController/updateProvince">
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/provinceController/deleteProvince?id="+id;
        else
            return false;
    }
</script>
        ...
        <div id="success" class="modal fade " role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="<?php echo base_url()?>index.php/provinceController/index" class="btn btn-circle green-meadow">بستن</a>
                    </div>
                </div>
            </div>
        </div>
