    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/carController/index">لیست  عراده جات سهمیه</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>عراده جات</b>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">لیست عراده جات سهمیه</span>
                                    </div>
                                    <div class="actions">
                                        ...
                                        <tbody style="text-align: center;">
                                          <?php foreach($data as $row){ ?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/carController/sahmeaDetail?id=<?=$row->id?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
