    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckAddAfraz">
                    <div class="form-body">
                    <div class="row">
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_type)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="type" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>" placeholder="date">
                                <div class="form-control-focus"> </div>
