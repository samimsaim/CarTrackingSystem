    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <b>ویرایش نمودن  واقعات آفات طبیعی</b>
                </li>
            </ul>
        </div>
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    ...
                    <span class="caption-subject bold uppercase">ویرایش نمودن  واقعات آفات طبیعی</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckEditVictime">
                    <div class="form-body">
                    <div class="row">
                    </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_province)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                ...
                                <select class="form-control" name="province" onchange="getDepartment()" id="fac">
                                    ...
                                    <option <?php if(!empty($Field_data['faculty']) && $Field_data['faculty'] == 0) echo ' selected '?> 
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_destrict)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="destrict" id="dep">
                                    ...
                                    <option <?php if(!empty($Field_data['dis']) && $Field_data['dis'] == 0) echo ' selected '?> value="<?=$des->name?>"><?=$des->name?></option>
                                </select>
                                <div class="form-control-focus"> </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_typeOfJob)) echo 'has-error' ?>">
                           ...
                           <div class="col-md-9">
                                <input type="text" class="form-control" name="typeOfJob" value="<?=$key->typOfJob?>" placeholder="نوعیت وظیفه">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_talafat)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="talafat">
                                   <option value="<?=$key->talafat?>"><?=$key->talafat?></option>
