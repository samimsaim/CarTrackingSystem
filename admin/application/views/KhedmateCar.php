    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/carController/khedmateCar">لیست  عراده جات خدمتی</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>عراده جات</b>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">لیست عراده جات خدمتی</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                               <!--  <div class="btn-group">
                                                  <a href="<?=base_url()?>index.php/fuelController/addFuel"><button id="sample_editable_1_new" class="btn btn-circle green-meadow"> اضافه نمودن
