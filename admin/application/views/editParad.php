    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckEditParad">
                    <div class="form-body">
                    <div class="row">
                    </div>
                    ...
                    <div class="row">
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_orgName)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="caus" value="<?=$key->cause?>" placeholder="علت تظاهرات">
                                <div class="form-control-focus"> </div>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_wish)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="wish" value="<?=$key->wish?>" placeholder="خواست مظاهره کننده ها">
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_plan)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="plan" value="<?=$key->plan?>" placeholder="محرکین">
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_type)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="type" value="<?=$key->type?>" placeholder="نوع تظاهرات">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_destroy)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="destroy" value="<?=$key->destroy?>" placeholder="خسارات">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_action)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="action" value="<?=$key->action?>" placeholder="اقدامات">
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_date)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="date" value="<?=$key->startDate?>" placeholder="date">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_date1)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="date1" value="<?=$key->endDate?>" placeholder="date">
                                <div class="form-control-focus"> </div>
