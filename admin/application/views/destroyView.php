    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/mainPageController/index">واقعات تخریب انفجار و حریق در مکاتب</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>واقعات تخریب انفجار و حریق در مکاتب</b>
                </li>
            </ul>
        </div>
                <div class="row">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">لواقعات تخریب انفجار و حریق در مکاتب</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                  <a href="<?=base_url()?>index.php/eventController/addDestroy"><button id="sample_editable_1_new" class="btn btn-circle green-meadow sbold green"> اضافه نمودن
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        <thead>
                                            <tr style="text-align: center;">
                                                ...
                                                <th style="text-align: center;"> تاریخ</th> <th style="text-align: center;">نوع حادثه</th>
                                                <th style="text-align: center;">خساره</th>
                                        ...
                                        <tbody style="text-align: center;">
                                          <?php foreach($data as $key) {?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><?=$key->dateOfOcure?></td>
                                               <td style="text-align: center;"><?=$key->typeOfEvent?></td>
                                               <td style="text-align: center;"><?=$key->typeOf?></td>
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/eventController/destroyDetail?id=<?=$key->id?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                                <a href="<?=base_url()?>index.php/eventController/editDestroy?id=<?=$key->id?>" title="ویرایش" class="btn btn-icon-only btn-circle btn-success">ویرایش</a>
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/eventController/deleteDestroy?id="+id;
        else
            return false;
    }
</script>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url()?>index.php/eventController/destroyView" class="btn btn-primary">بستن</a>
                </div>
            </div>
        </div>
    </div>
