                                        ...
                                        <tbody style="text-align: center;">
                                            <?php foreach($data as $row){ ?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/careRepController/carEventRep?id=<?=$row->year?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                               <a href="<?=base_url()?>index.php/transportRepController/deleteYear?id=<?=$row->year?>" class="btn  btn-icon-only btn-circle btn-danger"title="حذف">خذف</a>
                                              </td> 
                                            </tr>
                                          <?php }?>
                                        </tbody>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/transportRepController/addYear">
                    <div class="form-group">
                        <div class="form-group form-md-line-input col-md-6 has-success">
                            <input style="text-align: right;"  type="date" name="date" class="form-control date" id="form_control_1" placeholder="نام هیئت"  required>
