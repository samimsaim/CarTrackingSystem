    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn btn-circle green-meadow" href="<?=base_url()?>index.php/eventController/preventView" style="font-size: 16px;">
                        <i class="fa fa-share"></i>برگشت</a>
                    </a>
                </div>
            </div>
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckEditPrevent">
                    <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_numberOfEvent)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">تعداد واقعات جلوگیری*</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="numberOfEvent" value="<?=$key->numberOfEvent?>" placeholder="تعداد واقعات جلوگیری">
                                <div class="form-control-focus"> </div>
                                <?php if(!empty($error_numberOfEvent)){?>
                                    <span class="help-block-error" style="color:red;"><?=$error_numberOfEvent?></span>
                                <?php }?>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <a href="<?=base_url()?>index.php/eventController/preventView" class="btn btn-circle yellow-gold">لغو</a>
                                <input type="submit" name="addPrevent" class="btn btn-circle green-meadow" value="ذخیره"/>
                            </div>
                        </div>
                    </div>
                </form>
