    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/mainPageController/index">گزارش روزانه عراده جات</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>گزارش</b>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">گزارش روزانه عراده جات</span>
                                    </div>
                                    <div class="actions">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        <thead>
                                            <tr style="text-align: center;">
                                                ...
                                                <th style="text-align: center;">مبلایت</th>
                                            </tr>
                                        </thead>
                                        <tbody style="text-align: center;">
                                          <?php foreach($data as $row){ ?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/TransportRepController/purzaDaily?id=<?=$row->id?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                              </td>
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/TransportRepController/dailyFuel?id=<?=$row->id?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                              </td>
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/TransportRepController/dailyMoblail?id=<?=$row->id?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                              </td> 
                                            </tr>
                                           <?php }?>
                                        </tbody>
