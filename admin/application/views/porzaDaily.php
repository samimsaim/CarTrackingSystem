    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/UsersController/index">گزارش روزانه پرزه جات</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>گزارش</b>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">گزارش روزانه پرزه جات</span>
                </div>
                <div class="actions">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($value!=null) echo $key->taidadJens; else echo '0';?></td>
                                         <th>قیمت جنس</th>
                                        <td><?php if($value!=null) echo $key->qematJens; else echo '0';?></td>
                                    </tr>
