    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/studentController/index">اختطاف معلمین متعلمین و منسوبین</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>اضافه  نمودن  رویداد اختطاف </b>
                </li>
            </ul>
        </div>
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    ...
                    <span class="caption-subject bold uppercase">اضافه نمودن  رویداد اختظاف</span>
                </div>
                <div class="actions">
                    <a class="btn btn-circle green-meadow" href="<?=base_url()?>index.php/eventController/ekhtetafView" style="font-size: 16px;">
                        <i class="fa fa-share"></i>برگشت</a>
                    </a>
                </div>
            </div>
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckEitEkhtetaf">
                    <div class="form-body">
                    <div class="row">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_typeOfJob)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="typeOfJob">
                                   <option value="<?=$key->typOfJob?>"><?=$key->typOfJob?></option>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_number)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input style="text-align: right;" type="text" class="form-control" name="number" value="<?=$key->numberOf?>" placeholder="تعداد">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_date)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">تاریخ حادثه*</label>
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="date" value="<?=$key->dateOfOcure?>" placeholder="date">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_date1)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">تاریخ رهایی*</label>
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="date1" value="<?=$key->dateOfBack?>" placeholder="date">
                                <div class="form-control-focus"> </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <a href="<?=base_url()?>index.php/eventController/ekhtetafView" class="btn btn-circle yellow-gold">لغو</a>
                                <input type="submit" name="addEkhtetaf" class="btn btn-circle green-meadow" value="ذخیره"/>
                            </div>
                        </div>
                    </div>
                </form>
