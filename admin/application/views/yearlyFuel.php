    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/UsersController/index">گزارش  سالانه تیل موتر</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
                    <b>گزارش </b>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">گزارش   سالانه تیل موتر</span>
                </div>
                <div class="actions">
                                   ...
                                   <tr>
                                    ...
                                    <tr style="background-color: yellow;">
                                        ...
                                        $this->db->where('car_id',$row->id);
                                         ...
                                         $this->db->select_sum('fuelAmount');
                                        $result=$this->db->get('fuel')->row();
                                        $query= $result->fuelAmount;

                                         ?>
                                        <th>قیمت مجموعی تیل موتر در سال</th>
