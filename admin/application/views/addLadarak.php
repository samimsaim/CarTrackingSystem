    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <b>اضافه  نمودن  توقیف و لادرک پرسونل</b>
                </li>
            </ul>
        </div>
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    ...
                    <span class="caption-subject bold uppercase">اضافه نمودن  توقیف و لادرک پرسونل</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckAddLadarak">
                    <div class="form-body">
                    <div class="row">
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_typeOfEvent)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="typeOfEvent">
                                   <option value="0">نوعت حادثه</option>
                                    <option value="توقیف">توقیف</option>
                                    <option value="لادرک">لادرک</option>
                                </select>
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_typeOfJob)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="typeOfJob">
                                   <option value="0">نوعیت  وظیفه</option>
                                    <option value="معلم">معلم</option>
                                    <option value="مامور">مامور</option>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_twqefOrg)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">ارگان توقیف کننده*</label>
                            <div class="col-md-9">
                                <input style="text-align: right;" type="text" class="form-control" name="twqefOrg" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>" placeholder="ارگان توقیف کننده">
                                <div class="form-control-focus"> </div>
                                <?php if(!empty($error_twqefOrg)){?>
                                    <span class="help-block-error" style="color:red;"><?=$error_twqefOrg?></span>
                                <?php }?>
                            </div>
                        </div>
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_dateOfOcur)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">تاریخ توقیف/ لادرک*</label>
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="dateOfOcur" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>">
                                <div class="form-control-focus"> </div>
                                <?php if(!empty($error_dateOfOcur)){?>
                                    <span class="help-block-error" style="color:red;"><?=$error_dateOfOcur?></span>
                                <?php }?>
                            </div>
                        </div>
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_dateOfBack)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">تاریخ  دریافت / رهایی*</label>
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="dateOfBack" value="<?php if (!empty($Field_data['name'])) echo $Field_data['name']; ?>">
                                <div class="form-control-focus"> </div>
                                <?php if(!empty($error_dateOfBack)){?>
                                    <span class="help-block-error" style="color:red;"><?=$error_dateOfBack?></span>
                                <?php }?>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <a href="<?=base_url()?>index.php/eventController/ladarakView" class="btn btn-circle yellow-gold">لغو</a>
                                <input type="submit" name="addLadarak" class="btn btn-circle green-meadow" value="ذخیره"/>
                            </div>
                        </div>
                    </div>
                </form>
