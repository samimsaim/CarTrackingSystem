                                          ...
                                          <?php foreach($data as $key) {?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/eventController/ekhtetafDetail?id=<?=$key->id?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
                                                <a href="<?=base_url()?>index.php/eventController/editEkhtetaf?id=<?=$key->id?>" title="ویرایش" class="btn btn-icon-only btn-circle btn-success">ویرایش</a>
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/eventController/deleteEkhtetaf?id="+id;
        else
            return false;
    }
</script>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url()?>index.php/eventController/ekhtetafView" class="btn btn-primary">بستن</a>
                </div>
            </div>
        </div>
    </div>
