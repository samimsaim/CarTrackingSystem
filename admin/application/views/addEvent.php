    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckAddEvent">
                    <div class="form-body">
                    <div class="row">
                    </div>
                    <div class="row">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                ...
                                <input type="submit" name="addEvent" class="btn btn-circle green-meadow" value="ذخیره"/>
                            </div>
                        </div>
                    </div>
                </form>
