                                        ...
                                        <tbody style="text-align: center;">
                                            <?php foreach($data as $row){ ?>
                                             <tr class="odd gradeX">
                                              ...
                                              <td style="text-align: center;"><a href="<?=base_url()?>index.php/transportRepController/index?id=<?=$row->year?>" class="btn  btn-icon-only btn-circle green-meadow"title="جزئیات">جزئیات</a>
