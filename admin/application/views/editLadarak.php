    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="POST" action="<?=base_url()?>index.php/eventController/CheckEditLadarak">
                    <div class="form-body">
                    <div class="row">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_typeOfEvent)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="typeOfEvent">
                                   <option value="<?=$key->typeOfEvent?>"><?=$key->typeOfEvent?></option>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_typeOfJob)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="typeOfJob">
                                   <option value="<?=$key->typeOfJob?>"><?=$key->typeOfJob?></option>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_gender)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="gender">
                                   <option value="<?=$key->gender?>"><?=$key->gender?></option>
                          ...
                          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_twqefOrg)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input style="text-align: right;" type="text" class="form-control" name="twqefOrg" value="<?=$key->tawqefOrg?>" placeholder="ارگان توقیف کننده">
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_dateOfOcur)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="dateOfOcur" value="<?=$key->dateOfOcure?>">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_dateOfBack)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="dateOfBack" value="<?=$key->dateOfBack?>">
                                <div class="form-control-focus"> </div>
