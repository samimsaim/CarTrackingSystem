                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" >
                                        <thead style="background-color: gray; color: white;">
                                            <tr style="text-align: center; height: 60px;">
                                                ...
                                                <th style="text-align: center;padding-bottom: 20px;">تعداد</th>
                                                <th style="text-align: center;padding-bottom: 20px;">تاریخ</th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 30px;"><?=$key->orgName?></td>
                                             <td style="padding-top: 30px;"><?=$key->talafat?></td>
                                            <td style="padding-top: 30px;"><?=$key->typOfJob?></td>
                                            <td style="padding-top: 30px;"><?=$key->gender?></b></td>
                                            <td style="padding-top: 30px;"><?=$key->numberOf?></b></td>
                                            <td style="padding-top: 30px;">
                                                <?php 
