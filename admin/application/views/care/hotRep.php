    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="tiles" style="margin-right: 100px;" >
                <a href="<?=base_url()?>index.php/careRepController/shahedHot?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/ladarakHot?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/afatHot?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/carEventRep?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/ekhtetafHot?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/theftHot?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/destroyHot?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/afrazHot?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/threadHot?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/paradHot?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/preventHot?id=<?=$_GET['id'];?>">
                 <div class="tile double selected bg-yellow">
                    <div class="corner">
                    </div>
                    <div class="check">
