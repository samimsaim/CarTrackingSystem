    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="tiles" style="margin-right: 100px;" >
                <a href="<?=base_url()?>index.php/careRepController/shahedJade?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/ladarakJade?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/afatJade?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/carEventRep?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/ekhtetafJade?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/theftJade?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/destroyJade?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/afrazJade?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/threadJade?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/paradJade?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/preventJade?id=<?=$_GET['id'];?>">
                 <div class="tile double selected bg-yellow">
                    <div class="corner">
                    </div>
                    <div class="check">
