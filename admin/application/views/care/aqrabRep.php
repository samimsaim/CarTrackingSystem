    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="tiles" style="margin-right: 100px;" >
                <a href="<?=base_url()?>index.php/careRepController/shahedAqrab?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/ladarakAqrab?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/afatAqrab?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/carEventRep?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/ekhtetafAqrab?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/theftAqrab?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/destroyAqrab?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/afrazAqrab?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/threadAqrab?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/paradAqrab?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/preventAqrab?id=<?=$_GET['id'];?>">
                 <div class="tile double selected bg-yellow">
                    <div class="corner">
                    </div>
                    <div class="check">
