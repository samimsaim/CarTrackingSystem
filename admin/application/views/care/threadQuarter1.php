                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" >
                                        <thead style="background-color: gray; color: white;">
                                            <tr style="text-align: center; height: 60px;">
                                                ...
                                                <th style="text-align: center;padding-bottom: 20px;">تاریخ  خادثه
                                                <th style="text-align: center;padding-bottom: 20px;">نوع نهدید</th>
                                                <th style="text-align: center;padding-bottom: 20px;">مشاجره لفظی</th>
                                                <th style="text-align: center;padding-bottom: 20px;">اتخاذ تدابیر</th>
                                        ...
                                        <tbody style="text-align: center;">
                                           ...
                                           if(date('m', strtotime($key->date))==date('m', strtotime($id))){
                                            ?>
                                        <tr>
                                            ...
                                            <td style="padding-top: 30px;"><?=$key->orgName?></td>
                                             <td style="padding-top: 30px;"><?php 
                                                ...
                                                ?></td>
                                            <td style="padding-top: 30px;"><?=$key->typeOfThread?></td>
                                            <td style="padding-top: 30px;"><?=$key->mushajera?></td>
                                            <td style="padding-top: 30px;"><?=$key->etekhazTadaber  ?></td>
