                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" >
                                        <thead style="background-color: gray; color: white;">
                                            <tr style="text-align: center; height: 60px;">
                                                ...
                                                <th style="text-align: center;padding-bottom: 20px;">نوعیت رویداد
                                                <th style="text-align: center;padding-bottom: 20px;">تاریخ افراز</th>
                                                <th style="text-align: center;padding-bottom: 20px;">تاریخ خروج</th>
                                        ...
                                        <tbody style="text-align: center;">
                                           ...
                                           if(date('m', strtotime($key->insertDate))==date('m', strtotime($id))){
                                            ?>
                                        <tr>
