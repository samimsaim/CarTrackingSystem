    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="tiles" style="margin-right: 100px;" >
                <a href="<?=base_url()?>index.php/careRepController/shahedQuarter4?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/ladarakQuarter4?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/afatQuarter4?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/carEventRep?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/ekhtetafQuarter4?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/theftQuarter4?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/destroyQuarter4?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/afrazQuarter4?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/threadQuarter4?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/paradQuarter4?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/preventQuarter4?id=<?=$_GET['id'];?>">
                 <div class="tile double selected bg-yellow">
                    <div class="corner">
                    </div>
                    <div class="check">
