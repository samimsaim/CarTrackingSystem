    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="tiles" style="margin-right: 100px;" >
                <a href="<?=base_url()?>index.php/careRepController/shahedDalwa?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/ladarakDalwa?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/afatDalwa?id=<?=$_GET['id'];?>">
            ...
            <a href="<?=base_url()?>index.php/careRepController/carEventRep?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/ekhtetafDalwa?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/theftDalwa?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/destroyDalwa?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/afrazDalwa?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/threadDalwa?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/paradDalwa?id=<?=$_GET['id'];?>">
             ...
             <a href="<?=base_url()?>index.php/careRepController/preventDalwa?id=<?=$_GET['id'];?>">
                 <div class="tile double selected bg-yellow">
                    <div class="corner">
                    </div>
                    <div class="check">
